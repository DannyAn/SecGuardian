...
JSON
    ...
    for wrapper in init-scan.sh secguardian-index secguardian-index.ps1 render-report.py validate-index.py record-finding.py partition-signals.py verification-gate.py coverage-gate.py; do
