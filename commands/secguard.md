...
📋 统一入口: `.codeagent/secguard/sc-20260531-143000-a1b2/human/executive-summary.md`
📄 完整报告: `.codeagent/secguard/sc-20260531-143000-a1b2/report.md`
🌐 仪表盘: `.codeagent/secguard/sc-20260531-143000-a1b2/dashboard.html`
🤖 AI 修复包: `.codeagent/secguard/sc-20260531-143000-a1b2/ai/remediation-pack.json`
📊 SARIF: `.codeagent/secguard/sc-20260531-143000-a1b2/results.sarif`
📋 索引: `.codeagent/secguard/sc-20260531-143000-a1b2/manifest.json`
...
- 创建输出目录: `.codeagent/secguard/<scan_id>/`。
...
$TIMEOUT_CMD $INDEXER --lang <language> --path <path> --output <user-project>/.codeagent/index.json
...
```bash
SCAN_DIR=".codeagent/secguard/<scan_id>"
...
python3 "$RENDERER" \
    --command secguard \
    --findings-dir .codeagent/secguard/<scan_id>/findings/ \
    --index .codeagent/index.json \
    --output .codeagent/secguard/<scan_id>/
```
